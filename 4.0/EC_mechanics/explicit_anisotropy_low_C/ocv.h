...
public:
  ...
  virtual ScalarValue eval_U_ocv(const ScalarValue &c_val) const = 0;
  virtual ScalarValue eval_dU_ocv(const ScalarValue &c_val) const = 0;
};
...
public:
  ...
  ScalarValue eval_U_ocv(const ScalarValue &c_val) const override {
  ...
  ScalarValue eval_dU_ocv(const ScalarValue &c_val) const override {
    ScalarValue t_cheb =
            ((cheb_map_scale * (c_val - ocv_soc_min)) / ocv_soc_span) - 1.0;
