...
main(int argc, char *argv[])
{
  ...
  constant_block.field_indices = collect_indices(Fields::psi,
                                                 Subsets::stiffness(),
                                                 Subsets::eigenstrain(),
                                                 Subsets::diffusion());
  SolveBlock c_block;
  ...
  c_block.dependencies_rhs = make_dependency_set(fields,
                                                 collect_deps(Fields::mu.old_1(),
  ...
  u_block.dependencies_rhs = make_dependency_set(fields,
                                                 collect_deps(Fields::c.old_1(),
                                                              Fields::psi,
                                                              Subsets::stiffness(),
                                                              Subsets::eigenstrain()));
  u_block.dependencies_lhs = make_dependency_set(fields,
                                                 collect_deps(Fields::u.lhs().grad(),
                                                              Fields::psi,
                                                              Subsets::stiffness()));
  ...
  mu_block.dependencies_rhs = make_dependency_set(fields,
                                                  collect_deps(Fields::c,
                                                               Fields::u.grad(),
                                                               Fields::psi,
                                                               Subsets::stiffness(),
                                                               Subsets::eigenstrain()));
  ...
  if constexpr (has_Fracture)
    {
      ...
      fracture_block.dependencies_rhs =
        make_dependency_set(fields,
                            collect_deps(Fields::u.grad(),
                                         Fields::psi,
                                         Subsets::stiffness(),
                                         Subsets::eigenstrain(),
                                         Fields::gc_field));
